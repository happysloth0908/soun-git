    ...
    <div class="page-title" data-aos="fade">
      ...
      <!-- <nav class="breadcrumbs"> -->
        <div class="container">
            ...
            <a href="index.html" class="목록" style="float: left;"> <button class="목록버튼">목록</button></a></li>
            <a href="리뷰수정화면.html"class="리뷰생성" style="float: right;"> <button class="수정버튼">글수정</button></a></li>
            <a href="index.html" class="리뷰삭제" style="float: right;"> <button class="삭제버튼">글삭제</button></a></li>
        ...
        <form action="forms/contact.php" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="300">
          <div class="row gy-4">
            ...
            <div class="col-md-12">
              ...
              <div>=====${review.title}:::${review.content}=====</div>
              <div class="form-control" name="내용입력." rows="6" placeholder="기존리뷰내용" required="">기존리뷰내용 표시</div>
              <div class="col-md-12">
                <textarea class="form-control" name="추천" rows="6" placeholder="강추(),  추천()" required=""></textarea>
              </div>
