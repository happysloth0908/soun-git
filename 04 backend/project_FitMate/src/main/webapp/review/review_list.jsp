  ...
  <main class="main">
    ...
    <div class="container">
        ...
        <c:forEach var="review" items="${reviews}">
	        <ol class="pricing-item d-flex justify-content-between">
	            <li style="width: 10%;">${review.reviewId}</li>
	            <li style="width: 50%;"><a href="${pageContext.request.contextPath}/review?action=detail&reviewId=${review.reviewId}">${review.title}</a></li>
	            <li style="width: 20%;">${review.userId}</li>
	            <li style="width: 10%;">${review.viewCnt}</li>
